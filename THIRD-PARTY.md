...
Livraison 07 : les modules natifs et adaptations MM/LUS disposent de revues
par modification et d'empreintes contrôlées. Les scripts historiques sont
remplacés et les fichiers devenus inutiles retirés. Le jeu, les bibliothèques
et leurs interfaces publiques gardent leurs auteurs.
Voir docs/BLINKY-PROVENANCE.md et docs/BLINKY-REVIEWED-DELTAS.json.
...
| --- | --- | --- |
| SoH3DS V7 (provenance historique du dossier et de dépendances) | `SOH3DS-Compilateur-3D-MODS-V7.zip`, préfixe `SOH3DS-Compilateur/source` ; SHA-256 `55cf1562a9231f6101b02ed7517bf9af13e7993ab95a777de68f84dc3bbf92a1` | Conserver les notices des fichiers et bibliothèques de la base |
...
| libultraship | Base restaurée/comparée au LUS 7f9b86a593c526fc42261d7fe197100cecf57178, avec deltas Blinky et interfaces publiques attribuées ; origine [kenix3/libultraship](https://github.com/kenix3/libultraship) | `third_party/libultraship/LICENSE`, MIT |
| Rendu PICA200 natif | Nouvelle implémentation Blinky, contrats LUS et SDK publics | Voir docs/BLINKY-PROVENANCE.md |

Le build utilise third_party/libultraship. Les fichiers identiques au LUS
épinglé, les deltas Blinky et les adaptations d'interface sont distingués dans
l'inventaire. La ligne V7 conserve la provenance historique de l'arbre et des
copies de bibliothèques ; elle ne désigne plus un renderer natif actif.
Les empreintes et crédits des dépendances sont conservés.
...
- L'icône et la bannière sont créées par `scripts/package_3ds.py` avec des
  formes géométriques originales représentant deux voiles. L'audio de bannière est
